package com.htht.huoy.common.utils;
...
public class FileFormat {
     ...
     * @throws IOException
     */
    public static String getTextFromDoc(String filePath) throws IOException {
     ...
     * @return
     */
    public static String getTextFromText(String filePath) throws IOException{
